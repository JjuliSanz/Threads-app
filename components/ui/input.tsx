...
// Define the InputProps interface that extends input HTML attributes
...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  ({ className, type, ...props }, ref) => {
    return (
      // Render the input element with specified attributes and classNames
      <input
        type={type}
        className={cn(
          // Use cn function to concatenate classNames
...
Input.displayName = "Input"; // Set a display name for the component
